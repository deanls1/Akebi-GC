...
namespace cheat::feature
{
	...
	InteractiveMap::InteractiveMap() : Feature(),
		...
		NF(f_ShowMaterialsWindow, u8"材料过滤窗口", "InteractiveMap", false),
	...
	void InteractiveMap::DrawFilters(const bool searchFixed)
	{
		...
		ImGui::BeginGroupPanel(u8"提升材料过滤器");
		{
			ConfigWidget(u8"展示提升材料", f_ShowMaterialsWindow, "Open ascension materials filter window");
