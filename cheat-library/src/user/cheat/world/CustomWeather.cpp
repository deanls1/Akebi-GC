...
namespace cheat::feature
{
    ...
    CustomWeather::CustomWeather() : Feature(),
        NF(f_Enabled,u8"自定义天气", "CustomWeather", false),
        NF(f_Lightning, u8"高亮敌人", "CustomWeather", false),
    ...
    void CustomWeather::DrawMain()
    {
        ...
        if (f_Enabled)
            ConfigWidget(f_WeatherType, u8"选择天气类型");
        ConfigWidget(f_Lightning, u8"高亮目标敌人，在大雨天气下适用.");
    }
